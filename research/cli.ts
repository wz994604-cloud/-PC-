...
import { theoreticalBaseline,theoreticalModeBaseline,v01Model,v02CandidateA } from "./models";
...
const records=walkForward(draws,[theoreticalBaseline,theoreticalModeBaseline,v01Model,v02CandidateA],{mode:process.argv[3]==="rolling"?"rolling":"expanding"});
